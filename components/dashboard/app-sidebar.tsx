...
const superAdminNavItems: NavItem[] = [
  ...
  { title: "Departments", href: "/super-admin/departments", icon: Users },
      ...
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-2 px-2 py-2">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-sidebar-foreground">CivicPulse</span>
            <span className="text-xs text-sidebar-foreground/60 capitalize">{userRole.replace("-", " ")}</span>
          </div>
        </div>
      </SidebarHeader>
