-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('REPORT_SUBMITTED', 'REPORT_VERIFIED', 'REPORT_ASSIGNED', 'REPORT_REASSIGNED', 'REPORT_REJECTED', 'REPORT_RESOLVED', 'REPORT_EVIDENCE_ADDED', 'SLA_WARNING', 'SLA_OVERDUE', 'SYSTEM');
